...
# Page title
st.set_page_config(page_title='Support Ticket Workflow, welcome ', page_icon='🎫')
st.title('🎫 Support Ticket Omid')
st.info('To write a ticket, fill out the form below. Check status or review ticketing analytics using the tabs below. Omid will help you to solve your issues')
